    ...
    >
      ...
      <div className="mt-3 grid grid-cols-[auto_1fr] items-end gap-2 border-t border-slate-100 pt-3 text-xs">
        ...
        <div className="flex min-w-0 flex-col items-end gap-1.5">
          <span className={`max-w-full truncate rounded-full px-2 py-1 text-[10px] font-bold ${part.traceability_status === "DISABLED" ? "bg-red-50 text-red-600" : "bg-teal-50 text-teal-700"}`}>
            {t("traceability")}: {part.traceability_status === "DISABLED" ? t("disabled") : t("enabled")}
          </span>
