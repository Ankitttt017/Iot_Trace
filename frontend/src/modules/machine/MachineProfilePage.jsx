...
const OldLiveStateGraph = ({ status }) => {
...
const InfoTile = ({ label, value, valueClass, icon, iconBg }) => (
...
const InlineNumberEdit = ({ value, onChange }) => {
...
const ConnectionTypeSelect = ({ value, onChange }) => (
...
// ── Downtime Tab ──────────────────────────────────────────────────────────────
const buildDowntimeTrend = (machineName = "") => {
...
const TrendLine = ({ points, color, getValue, maxValue, width, height, leftPad, rightPad, topPad, bottomPad }) => {
...
const AdhesiveCoatingMachineSVG = () => (
...
const MachineImagePanel = ({ machineName, status }) => {
...
const InfoRow = ({ label, value, highlight, editable = true, onEdit }) => (
